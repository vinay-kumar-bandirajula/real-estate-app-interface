...
const About = () => {
  return (
    <motion.div
      ...
      viewport={{once: true}}
    className='flex flex-col items-center justify-center container mx-auto p-14 md:p-20 lg:p-32 2-full overflow-hidden' id='About'>
      ...
      <div className='flex flex-col md:flex-row items-center md:item-start md:gap-20'>
        ...
        <div className='flex flex-col items-center md:items-start mt-10 text-gray-600'>
          ...
          <p className='my-10 max-w-lg'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit aliquid facilis ab velit, sunt provident dolor eaque reiciendis cumque! Rerum est adipisci natus explicabo rem molestias error! Quis, nulla quam.</p>
